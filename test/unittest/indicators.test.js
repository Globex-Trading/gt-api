...
const { sma_inc,
    ...
    md_inc,
    rocr_inc,
    vwma_inc } = require('../../helper/indicators');
...
describe('indicator test', () => {
    it('sma', async () => {
        expect(typeof await sma_inc(data)).toBe('object');
    });
    it('ema', async () => {
        expect(typeof await ema_inc(data)).toBe('object');
    });

    it('bband', async () => {
        expect(typeof await bbands_inc(data)).toBe('object');
    });

    it('wma', async () => {
        expect(typeof await wma_inc(data)).toBe('object');
    });

    it('rsi', async () => {
        expect(typeof await rsi_inc(data)).toBe('object');
    });

    it('macd', async () => {
        expect(typeof await macd_inc(data)).toBe('object');
    });

    it('roc', async () => {
        expect(typeof await roc_inc(data)).toBe('object');
    });
    it('stoch', async () => {
        expect(typeof await stoch_inc(data)).toBe('object');
    });
    it('obv', async () => {
        expect(typeof await obv_inc(data)).toBe('object');
    });

    it('md', async () => {
        expect(typeof await md_inc(data)).toBe('object');
    });
    it('rocr', async () => {
        expect(typeof await rocr_inc(data)).toBe('object');
    });
    it('vwma', async () => {
        expect(typeof await vwma_inc(data)).toBe('object');
    });
